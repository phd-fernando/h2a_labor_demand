...
#
# Automation adoption signals in CITRUS H-2A job orders.
# Identical three-step methodology as script 18 (strawberry).
# Only the crop filter and focal-crop stopwords differ.
#
# Citrus filter:
#   farmer-entered cropActivity contains any of:
#     citrus, orange, grapefruit, tangerine, lemon, lime, mandarin, clementine
#   OR duties text contains the same keywords.
#
...
# ==============================================================================
CROP_NAME    <- "Citrus"
CROP_PATTERN <- "citrus|orange|grapefruit|tangerine|lemon|lime|mandarin|clementine"
CROP_WORDS   <- c("citrus","orange","grapefruit","tangerine","lemon","lime",
                  "mandarin","clementine","grove","orchard")  # focal words to remove
SLUG         <- "citrus"   # used in output filenames
