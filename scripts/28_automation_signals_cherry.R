...
# Automation adoption signals in CHERRY H-2A job orders.
# Only the crop filter and focal-crop stopwords differ.
#
# Cherry filter:
#   farmer-entered cropActivity contains "cherr"
#   OR duties text contains "cherr"
# Note: Shake harvesters used for tart (processing) cherries; sweet cherries still largely hand-picked.
#
...
CROP_NAME    <- "Cherry"
CROP_PATTERN <- "cherr"
CROP_WORDS   <- c("cherry","cherries","tart","sour")
SLUG         <- "cherry"
