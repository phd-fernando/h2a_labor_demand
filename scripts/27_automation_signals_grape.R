...
# Automation adoption signals in GRAPE H-2A job orders.
# Only the crop filter and focal-crop stopwords differ.
#
# Grape filter:
#   farmer-entered cropActivity contains "grape"
#   OR duties text contains "grape"
# Note: Mechanical pruning and harvesting well-established in wine grapes; table and raisin grapes lag.
#
...
# ==============================================================================
CROP_NAME    <- "Grape"
CROP_PATTERN <- "grape|vineyard|raisin"
CROP_WORDS   <- c("grape","grapes","vineyard","vineyards","raisin","raisins","winegrape","wine")
SLUG         <- "grape"
