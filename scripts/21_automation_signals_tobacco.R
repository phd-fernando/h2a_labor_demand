...
#
# Automation adoption signals in TOBACCO H-2A job orders.
# Identical three-step methodology as script 18 (strawberry).
# Only the crop filter and focal-crop stopwords differ.
#
# Tobacco filter:
#   farmer-entered cropActivity contains "tobacco"
#   OR duties text contains "tobacco".
#
...
# ==============================================================================
CROP_NAME    <- "Tobacco"
CROP_PATTERN <- "tobacco"
CROP_WORDS   <- c("tobacco","flue","burley","cured","curing","tobacc")
SLUG         <- "tobacco"   # used in output filenames
