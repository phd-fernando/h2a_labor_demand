...
# Automation adoption signals in CUCUMBER H-2A job orders.
# Only the crop filter and focal-crop stopwords differ.
#
# Cucumber filter:
#   farmer-entered cropActivity contains "cucumber"
#   OR duties text contains "cucumber"
# Note: Processing cucumbers machine-harvested (once-over); fresh-market cucumbers and squash remain hand-picked.
#
...
# ==============================================================================
CROP_NAME    <- "Cucumber"
CROP_PATTERN <- "cucumber|squash|zucchini"
CROP_WORDS   <- c("cucumber","cucumbers","squash","zucchini","pickle","pickles","cukes")
SLUG         <- "cucumber"
