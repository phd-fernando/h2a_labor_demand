...
# Automation adoption signals in APPLE H-2A job orders.
# Only the crop filter and focal-crop stopwords differ.
#
# Apple filter:
#   farmer-entered cropActivity contains "apple"
#   OR duties text contains "apple"
# Note: One of the most-studied crops for robotic harvesting R&D. Platform-assisted picking and mechanical thinning documented.
#
...
CROP_NAME    <- "Apple"
CROP_PATTERN <- "apple"
CROP_WORDS   <- c("apple","apples","orchard","orchards","cider","fuji","gala","honeycrisp","braeburn","cortland")
SLUG         <- "apple"
