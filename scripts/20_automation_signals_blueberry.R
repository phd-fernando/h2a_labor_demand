...
#
# Automation adoption signals in BLUEBERRY H-2A job orders.
# Identical three-step methodology as script 18 (strawberry).
# Only the crop filter and focal-crop stopwords differ.
#
# Blueberry filter:
#   farmer-entered cropActivity contains "blueberr"
#   OR duties text contains "blueberr".
#
...
# ==============================================================================
CROP_NAME    <- "Blueberry"
CROP_PATTERN <- "blueberr"
CROP_WORDS   <- c("blueberry","blueberries","blueberr","highbush","rabbiteye")
SLUG         <- "blueberry"   # used in output filenames
