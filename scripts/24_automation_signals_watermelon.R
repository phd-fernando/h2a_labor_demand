...
#
# Automation adoption signals in WATERMELON H-2A job orders.
# Identical three-step methodology as script 18 (strawberry).
# Only the crop filter and focal-crop stopwords differ.
#
# Watermelon filter:
#   farmer-entered cropActivity contains "watermelon" or "melon"
#   OR duties text contains "watermelon"
# Note: watermelon harvest involves heavy lifting (20-30 lb fruit) passed hand-
# to-hand down a line to a conveyor/truck — the "float line" or "cut crew"
# system. Mechanization in this crop targets the bin-conveyor interface and
# cutting/loading rather than picking itself.
#
...
CROP_PATTERN <- "watermelon"
CROP_WORDS   <- c("watermelon","watermelons","melon","melons","cantaloupe")
SLUG         <- "watermelon"   # used in output filenames
