...
# Automation adoption signals in BRASSICA H-2A job orders.
# Only the crop filter and focal-crop stopwords differ.
#
# Brassica filter:
#   farmer-entered cropActivity contains "broccoli"
#   OR duties text contains "broccoli"
# Note: Broccoli has commercial mechanical harvesters (once-over for processing). Cabbage largely hand-harvested.
#
...
# ==============================================================================
CROP_NAME    <- "Brassica"
CROP_PATTERN <- "broccoli|cauliflower|cabbage|kale|kohlrabi"
CROP_WORDS   <- c("broccoli","cauliflower","cabbage","kale","kohlrabi","brussels","collard","chard")
SLUG         <- "brassica"
