...
#
# Automation adoption signals in TOMATO H-2A job orders.
# Identical three-step methodology as script 18 (strawberry).
# Only the crop filter and focal-crop stopwords differ.
#
# Tomato filter:
#   farmer-entered cropActivity contains "tomato"
#   OR duties text contains "tomato"
# Note: fresh-market tomatoes are largely hand-harvested; processing tomatoes
# are mechanically harvested. This corpus captures both, but FL/NC hand-harvest
# operations dominate H-2A filings.
#
...
CROP_NAME    <- "Tomato"
CROP_PATTERN <- "tomato"
CROP_WORDS   <- c("tomato","tomatoes","tomatoe")
SLUG         <- "tomato"   # used in output filenames
